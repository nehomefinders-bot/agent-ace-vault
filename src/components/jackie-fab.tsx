...
export function JackieFab() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-[5.25rem] right-4 z-50 inline-flex min-h-11 items-center gap-2 rounded-full border border-primary/30 bg-card/95 px-4 py-3 text-sm font-medium text-foreground shadow-[0_12px_30px_-12px_rgba(0,0,0,0.55)] backdrop-blur-xl transition hover:border-primary/45 hover:bg-card md:bottom-24 md:right-6"
    >
